...
#define CONFIGJ_USE_UART_4	//########
#define CONFIGJ_USE_UART_2	//########
//#undef CONFIGJ_USE_UART_2	//########
...
void disable_watchdog(void)
{
	...
	mxc_iomux_v3_setup_pad(MX6Q_PAD_EIM_D19__GPIO_3_19);
#elif defined CONFIG_MX6DL
	mxc_iomux_v3_setup_pad(MX6DL_PAD_EIM_A24__GPIO_5_4);
	mxc_iomux_v3_setup_pad(MX6DL_PAD_EIM_D19__GPIO_3_19);
#endif
...
// inizio parte commentata
 ...
 // fine parte commentata
	...
	/* board id for linux */
	gd->bd->bi_arch_number = MACH_TYPE_MX6_UDOO;
...
int checkboard(void)
{
	printf("Board: %s-UDOO: %s Board: 0x%x [",
	mx6_chip_name(),
	mx6_board_rev_name(),
	fsl_system_rev);
