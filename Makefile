...
mx6q_udoo_config	: unconfig
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa8 mx6_udoo freescale mx6

mx6dl_udoo_config   : unconfig
	@[ -z "$(findstring iram_,$@)" ] || \
		{ echo "TEXT_BASE = 0x00907000" >$(obj)board/freescale/mx6_udoo/config.tmp ; \
		  echo "... with iram configuration" ; \
		}
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa8 mx6_udoo freescale mx6
